...
public class TestTimeSeries {
    ...
    public void testFromSpec() {
        ...
        List<Double> expectedTotal = new ArrayList<>
                (Arrays.asList(0.0, 100.0, 400.0, 500.0));
    ...
    public void testYear() {
        TimeSeries catPopulation = new TimeSeries();
        catPopulation.put(1991, 0.0);
        catPopulation.put(1998, 100.0);
        catPopulation.put(1994, 200.0);
        List<Integer> expectedYears = new ArrayList<>
                (Arrays.asList(1991, 1994, 1998));
    ...
    public void testValue() {
        ...
        List<Double> expectedValue = new ArrayList<>
                (Arrays.asList(0.0, 200.0, 100.0));

        assertEquals(expectedValue, catPopulation.data());
    ...
    public void testDiv() {
        ...
        List<Double> expectedTotal = new ArrayList<>
                (Arrays.asList(0.0, 100.0, 1.0, 500.0));
